...
class Dlib_Face_Unlock:
    ...
    def __init__(self):
        ...
        try:
            ...
            with open(r'E:\Study\Project\New folder\test face\labels.pickle', 'rb') as self.f:
        ...
        if self.labels_ids != self.og_labels:
            ...
            with open(r'E:\Study\Project\New folder\test face\KnownFace.pickle', 'rb') as self.faces_file:
...
def register():
    ...
    while True:
        ...
        if k % 256 == 27:
            ...
            # SPACE pressed
            img_name = str(numberOfFile) + ".jpg"
            cv2.imwrite(img_name, frame)
            print("{} written!".format(img_name))
            os.replace(str(numberOfFile) + ".jpg", "images/" + name.get().lower() + "/" + str(numberOfFile) + ".jpg")
            cam.release()
            cv2.destroyAllWindows()
            break
